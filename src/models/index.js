...
db.country.hasMany(db.warehouse, { foreignKey: 'countryCode' });
db.warehouse.belongsTo(db.country, { foreignKey: 'countryCode' });
...
db.order_payment.hasMany(db.order);
db.order.belongsTo(db.order_payment, { as: 'orderPayment' });
